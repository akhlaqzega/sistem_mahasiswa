...
@section('content')
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-2xl font-semibold text-gray-800">Tambah Mahasiswa</h1>
        ...
        <form action="{{ route('admin.mahasiswa.store') }}" method="POST">
            ...
            <div class="px-6 py-4">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="fakultas" id="fakultas" required value="{{ old('fakultas') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="jurusan" id="jurusan" required value="{{ old('jurusan') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="semester" id="semester" required value="{{ old('semester') }}"
